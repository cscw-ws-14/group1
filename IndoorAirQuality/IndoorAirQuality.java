...
initialize("#", component("MosquittoSubscriber"), port("TOPIC"));
initialize("AirSensor",component("MosquittoSubscriber"), port("FILTER[0]"));
initialize("VOC",component("MosquittoSubscriber"), port("FILTER[1]"));
initialize("cscw-bplus-",component("MosquittoSubscriber"), port("EXTRAINFO"));

initialize("#", component("MosquittoSubscriber2"), port("TOPIC"));
initialize("Outside_Temp",component("MosquittoSubscriber2"), port("FILTER[0]"));
