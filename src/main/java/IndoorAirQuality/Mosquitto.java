...
@InPorts({
    ...
    @InPort(value = "TOPICMESSAGE", description = "topic and message", type = String.class)
})
...
public class Mosquitto extends Component{
    ...
    private InputPort topicMessage;
...
//    private OutputPort outport;
    ...
    private String toppicmessageStr;
    @Override
    protected void execute() throws Exception {
        ...
        _clientId = (String) fillInput(clientId, _clientId);
        	...
        	Packet pT = topicMessage.receive();
        	
        	toppicmessageStr    = (String) pT.getContent();
            drop(pT);

            StringTokenizer st = new StringTokenizer(toppicmessageStr,"^");
           
            _topic = st.nextToken();
            _content = st.nextToken();
    ...
    protected void openPorts() {
        ...
        topicMessage =  openInput("TOPICMESSAGE");
    }
